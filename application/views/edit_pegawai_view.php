				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<?php echo form_open_multipart('pegawai/update/'.$this->uri->segment(3)); ?>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="nama" name="nama" placeholder="Masukan Nama Anda" value="<?php echo $key['nama'] ?>">
									<label for="">Nip</label>
									<input type="text" class="form-control" id="nama" name="nip" placeholder="Masukan NIP Anda" value="<?php echo $key['nip'] ?>">
									...
									<input type="text" class="form-control" id="nama" name="alamat" placeholder="Masukan Alamat Anda" value="<?php echo $key['alamat'] ?>">
								</div>
								<div class="form-group">
